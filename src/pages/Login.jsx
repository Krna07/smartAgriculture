      ...
      <div className="relative z-10 flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          ...
          <div className="bg-slate-900/80 backdrop-blur-md border border-slate-700 rounded-2xl p-8">
            ...
            {/* Demo credentials */}
            <div className="mt-5 p-4 bg-slate-800/60 border border-slate-700 rounded-xl">
              <p className="text-slate-400 text-xs font-semibold uppercase tracking-widest mb-2">Try Demo Account</p>
              <div className="space-y-1 text-sm font-mono">
                <div className="flex justify-between">
                  <span className="text-slate-500">Email</span>
                  <span className="text-green-400">demo@smartagri.io</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Password</span>
                  <span className="text-green-400">demo1234</span>
                </div>
              </div>
              <button
                type="button"
                onClick={() => setForm({ email: 'demo@smartagri.io', password: 'demo1234' })}
                className="w-full mt-3 py-1.5 text-xs font-semibold text-slate-300 bg-slate-700 hover:bg-slate-600 rounded-lg transition-colors"
              >
